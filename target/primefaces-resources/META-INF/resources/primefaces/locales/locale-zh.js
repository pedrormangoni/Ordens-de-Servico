/* Simplified Chinese (zh-CN) Language | Written by IKKI | 2021-12-25 */
 PrimeFaces.locales['zh'] = {
     ...
     messages: { // 客户端验证选项
         ...
         'jakarta.validation.constraints.AssertFalse.message': '必须是“false”！',
         'jakarta.validation.constraints.AssertTrue.message': '必须是“true”！',
         'jakarta.validation.constraints.DecimalMax.message': '必须小于或等于“{0}”！',
         'jakarta.validation.constraints.DecimalMin.message': '必须大于或等于“{0}”！',
         'jakarta.validation.constraints.Digits.message': '数值越界“{0}”位！只允许“{1}”位！',
         'jakarta.validation.constraints.Past.message': '必须是过去时间！',
         'jakarta.validation.constraints.Future.message': '必须是未来时间！',
         ...
         'jakarta.validation.constraints.Null.message': '必须是“null”！',
         'jakarta.validation.constraints.Pattern.message': '必须匹配“{0}”！',
         'jakarta.validation.constraints.Size.message': '大小必须介于“{0}”和“{1}”之间！'
     }
};
