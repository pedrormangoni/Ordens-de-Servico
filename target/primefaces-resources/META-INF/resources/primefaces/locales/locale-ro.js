...
PrimeFaces.locales['ro'] = {
    ...
    messages: {
        ...
        'jakarta.validation.constraints.Digits.message': 'valoare numerică în afara limitelor (&lt;{0} digits>.&lt;{1} digits> expected).',
        'jakarta.validation.constraints.Future.message': 'trebuie să fie în viitor.',
        ...
        'jakarta.validation.constraints.NotNull.message': 'poate să nu fie nul.',
        'jakarta.validation.constraints.Null.message': 'trebuie să fie nul.',
        'jakarta.validation.constraints.Past.message': 'trebuie să fie în trecut.',
